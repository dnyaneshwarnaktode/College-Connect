...
export default function ReplyModal({ isOpen, onClose, postTitle, onSave }: ReplyModalProps) {
      ...
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block w-full max-w-lg p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-900 shadow-xl rounded-2xl">
          ...
          <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400">Replying to:</p>
            <p className="font-medium text-gray-900 dark:text-white">{postTitle}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                placeholder="Share your thoughts or provide helpful information..."
                required
              />
            </div>
